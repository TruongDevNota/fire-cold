...
[CreateAssetMenu(fileName = "CharacterDatasAsset", menuName = "DataAsset/CharacterDatasAsset")]
public class SkinsAsset : BaseAsset<SkinData>
{
    [Header("Config")]
    ...
    [ButtonMethod]
    public List<SkinData> GetNotUnlockedSkin()
    {
