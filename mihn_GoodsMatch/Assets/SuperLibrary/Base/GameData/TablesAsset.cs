...
using MyBox;
[CreateAssetMenu(fileName = "TalbleDataAsset", menuName = "DataAsset/TalbleDataAsset")]

public class TablesAsset : BaseAsset<TableData>
{
    [Header("Config")]
    ...
    [ButtonMethod]
    public List<TableData> GetNotUnlockedSkin()
    {
...
[Serializable]
public class TableData : SaveData
{
    [Header("GameData")]
