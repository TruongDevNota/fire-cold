...
[CreateAssetMenu(fileName = "ChairsDataAsset", menuName = "DataAsset/ChairsDataAsset")]
public class ChairsAsset : BaseAsset<ChairData>
{
    [Header("Config")]
    ...
    [ButtonMethod]
    public List<ChairData> GetNotUnlockedSkin()
    {
        List<ChairData> allChairs = new List<ChairData>();
...
[Serializable]
public class ChairData : SaveData
{
    [Header("GameData")]
